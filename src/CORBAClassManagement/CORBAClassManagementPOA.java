 ...
 implements CORBAClassManagementOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CORBAClassManagement/CORBAClassManagement/login
       {
       ...
       case 1:  // CORBAClassManagement/CORBAClassManagement/logout
       {
         this.logout ();
         out = $rh.createReply();
         break;
       ...
       case 2:  // CORBAClassManagement/CORBAClassManagement/createTRecord
       {
         String managerID = in.read_string ();
       ...
       case 3:  // CORBAClassManagement/CORBAClassManagement/getRecordCounts
       {
         String $result = null;
       ...
       case 4:  // CORBAClassManagement/CORBAClassManagement/editRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
       ...
       case 5:  // CORBAClassManagement/CORBAClassManagement/createSRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
         String firstName = in.read_string ();
       ...
       case 6:  // CORBAClassManagement/CORBAClassManagement/transferRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
